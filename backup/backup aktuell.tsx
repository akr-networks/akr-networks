      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <h2 className="text-5xl md:text-7xl font-black leading-[0.98] mb-6 tracking-tight text-[#163328]">
            Stabiles WLAN &
            <span className="bg-gradient-to-r from-[#163328] via-emerald-500 to-teal-400 bg-clip-text text-transparent">
              {' '}moderne Netzwerke
            </span>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-6 py-24">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="text-5xl font-bold mb-6 text-[#163328]">
              Unverbindlich Kontakt aufnehmen
            </h2>

            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Fragen zu WLAN, Netzwerk oder Infrastruktur?
              Schreiben Sie uns einfach – wir melden uns schnellstmöglich zurück.
            </p>
          ...
          >
            ...
            <button
              type="submit"
              className="w-full md:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-[#163328] via-emerald-500 to-teal-400 text-white font-semibold shadow-[0_10px_35px_rgba(16,185,129,0.35)] hover:scale-[1.02] transition duration-300"
            >
              Anfrage senden
            </button>
